"""Synthetic data for every demo. Mirrors api/src/data.ts exactly.
Nothing here describes a real person, plan, employer, provider or claim."""
...
_ADDR = {"line1": "1420 Linden Ave SE", "city": "Cedar Rapids", "state": "IA", "zip": "52403"}
_PCP = {"npi": "1932014487", "name": "Dr. Elena Rausch", "practice": "Cedar Rapids Family Medicine"}

MEMBERS: dict[str, dict[str, Any]] = {
    "W20419873": {"memberId": "W20419873", "name": "Dana Whitfield", "dob": "1984-03-12", "relationship": "Subscriber", "groupId": "G-44812", "planId": "PPO1500", "coverageStart": "2024-01-01", "coverageEnd": None, "status": "Active", "address": dict(_ADDR), "phone": "319-555-0187", "email": "dana.whitfield@example.com", "pcp": dict(_PCP), "idCardLastIssued": "2026-01-04"},
    "W20419874": {"memberId": "W20419874", "name": "Marcus Whitfield", "dob": "1982-11-02", "relationship": "Spouse", "groupId": "G-44812", "planId": "PPO1500", "coverageStart": "2024-01-01", "coverageEnd": None, "status": "Active", "address": dict(_ADDR), "phone": "319-555-0187", "email": "marcus.whitfield@example.com", "pcp": dict(_PCP), "idCardLastIssued": "2026-01-04"},
    "W20419875": {"memberId": "W20419875", "name": "Ava Whitfield", "dob": "2017-06-21", "relationship": "Child", "groupId": "G-44812", "planId": "PPO1500", "coverageStart": "2024-01-01", "coverageEnd": None, "status": "Active", "address": dict(_ADDR), "phone": "319-555-0187", "email": "", "pcp": {"npi": "1710338822", "name": "Dr. Noor Haddad", "practice": "Kirkwood Pediatrics"}, "idCardLastIssued": "2026-01-04"},
}
FAMILY_IDS = ["W20419873", "W20419874", "W20419875"]

_PA_LIST = ["Advanced imaging (MRI, CT, PET)", "Inpatient admission", "Physical therapy beyond 12 visits per year", "Bariatric surgery", "Specialty drugs"]
PLANS = {
    "PPO1500": {"planId": "PPO1500", "name": "Prairie PPO 1500", "type": "PPO", "network": "Prairie Choice PPO", "deductible": {"individual": 1500, "family": 3000}, "outOfPocketMax": {"individual": 5000, "family": 10000}, "coinsurance": 0.2, "copays": {"pcp": 25, "specialist": 50, "urgentCare": 60, "emergency": 250, "telehealth": 0}, "outOfNetwork": {"deductible": {"individual": 3000, "family": 6000}, "coinsurance": 0.4}, "preventive": "Covered in full in-network", "priorAuthRequired": _PA_LIST},
    "HDHP3000": {"planId": "HDHP3000", "name": "Prairie HDHP 3000", "type": "HDHP (HSA-eligible)", "network": "Prairie Choice PPO", "deductible": {"individual": 3000, "family": 6000}, "outOfPocketMax": {"individual": 6000, "family": 12000}, "coinsurance": 0.1, "copays": {"pcp": 0, "specialist": 0, "urgentCare": 0, "emergency": 0, "telehealth": 0}, "outOfNetwork": {"deductible": {"individual": 6000, "family": 12000}, "coinsurance": 0.4}, "preventive": "Covered in full in-network", "priorAuthRequired": _PA_LIST},
}

DENTAL_PLAN = {"planId": "DENT-PLUS", "name": "Prairie Dental Plus", "system": "DENTAL_ADMIN", "coverage": {"preventive": {"covered": 1.0, "note": "Two cleanings and exams per year, bitewing x-rays once per year"}, "basic": {"covered": 0.8, "note": "Fillings, simple extractions, periodontal maintenance"}, "major": {"covered": 0.5, "note": "Crowns, bridges, dentures, implants; 6-month waiting period waived"}, "orthodontia": {"covered": 0.5, "lifetimeMax": 1500, "note": "Dependent children under 19 only"}}, "annualMax": 1500, "deductible": 50}
VISION_PLAN = {"planId": "VIS-STD", "name": "Prairie Vision", "system": "VISION_PARTNER", "examCopay": 10, "examFrequency": "Once every 12 months", "framesAllowance": 150, "framesFrequency": "Once every 24 months", "lensesCopay": 25, "contactsAllowance": 130, "lasikDiscount": "15% off at participating providers"}
PHARMACY_BENEFIT = {
    "system": "PBM",
    ...
    "formulary": {
        "atorvastatin": {"tier": 1, "priorAuth": False, "alternatives": []},
...
SPENDING_ACCOUNTS = {"system": "SPENDING_ACCOUNTS", "W20419873": {"fsa": {"election": 1200, "balance": 640, "planYearEnd": "2026-12-31", "gracePeriodEnd": "2027-03-15", "card": "Active"}, "hsa": None}}
...
PRIOR_AUTHS = [
    ...
    {"authId": "PA-26-1402", "memberId": "W20419874", "service": "Sleep study (CPT 95810)", "requestedBy": "Dr. Elena Rausch, Cedar Rapids Family Medicine", "requestedDate": "2026-09-04", "decision": "Pending clinical review", "decisionDate": None, "validFrom": None, "validThrough": None, "units": 1, "expectedDecision": "2026-09-12"},
]
...
CONTRACTS = [
    {"npi": "1932014487", "contractId": "CT-PPO-2211", "effective": "2023-01-01", "termination": None, "feeSchedule": "Prairie PPO Professional 2026", "status": "Active"},
    ...
    {"npi": "1841177204", "contractId": None, "effective": None, "termination": None, "feeSchedule": None, "status": "Not contracted", "note": "Recruitment outreach opened 2026-05-12; no response."},
]

GROUP: dict[str, Any] = {
    "groupId": "G-44812", "name": "Cedar Rapids Machine Works", "industry": "Precision machining", "address": "5100 Rockwell Dr NE, Cedar Rapids, IA 52402",
    ...
    "effectiveDate": "2022-01-01", "renewalDate": "2027-01-01", "contractPeriod": "2026-01-01 to 2026-12-31",
    "eligibleEmployees": 214, "enrolledSubscribers": 183, "totalCoveredLives": 397, "waitingPeriod": "First of the month after 30 days",
    ...
    "invoices": [
        ...
        {"invoiceId": "INV-2026-09", "period": "September 2026", "amount": 189105, "due": "2026-09-15", "paid": None, "status": "Open"},
    ],
...
def member_accumulators(member_id: str) -> dict[str, Any]:
    return ACCUMULATORS[member_id]


def estimate_cost_share(member_id: str, allowed_amount: float, service_type: str) -> dict[str, Any]:
    """Same estimator as data.ts: copay types are flat; 'other' applies deductible then coinsurance, capped by OOP."""
    plan = PLANS["PPO1500"]
    acc = ACCUMULATORS.get(member_id)
    if not acc or "dental" not in acc:
        return {"error": f"No accumulators for {member_id}"}
    if service_type != "other":
        copay = plan["copays"][service_type]
        return {"serviceType": service_type, "allowedAmount": allowed_amount, "memberPays": copay, "planPays": max(0, allowed_amount - copay), "basis": f"Flat {service_type} copay of ${copay}; deductible does not apply."}
    fam = ACCUMULATORS["family"]
    ded_remaining = max(0, min(acc["deductible"]["limit"] - acc["deductible"]["met"], fam["deductible"]["limit"] - fam["deductible"]["met"]))
    toward = min(allowed_amount, ded_remaining)
    after = allowed_amount - toward
    coins = round(after * plan["coinsurance"])
    oop_remaining = acc["oop"]["limit"] - acc["oop"]["met"]
    member_pays = min(toward + coins, oop_remaining)
    return {"serviceType": service_type, "allowedAmount": allowed_amount, "deductibleRemainingBefore": ded_remaining, "appliedToDeductible": toward, "coinsurance": coins, "memberPays": member_pays, "planPays": allowed_amount - member_pays, "outOfPocketMetBefore": acc["oop"]["met"], "outOfPocketMetAfter": acc["oop"]["met"] + member_pays, "outOfPocketLimit": acc["oop"]["limit"], "basis": f"Remaining deductible first, then {int(plan['coinsurance'] * 100)}% coinsurance, capped by the out-of-pocket maximum."}
